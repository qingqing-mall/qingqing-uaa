...
/**
 * REST controller for managing {@link com.liaoyb.qingqing.uaa.domain.Role}.
 */
@RestController
@RequestMapping("/api")
public class RoleResource {
     ...
     */
    @GetMapping("/roles")
    public ResponseEntity<List<RoleDTO>> getAllRoles(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
