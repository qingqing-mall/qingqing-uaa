...
/**
 * REST controller for managing {@link com.liaoyb.qingqing.uaa.domain.Permission}.
 */
@RestController
@RequestMapping("/api")
public class PermissionResource {
    ...
    public ResponseEntity<List<PermissionDTO>> getAllPermissions(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
